...
import { Droplets, User, Shield, Briefcase, ArrowRight, Loader2 } from 'lucide-react';
...
const roles: { value: UserType['role']; label: string; icon: any; description: string; color: string }[] = [
  {
    value: 'Admin',
    label: 'Administrator',
    icon: Shield,
  ...
  const handleLogin = async () => {
    if (!selectedRole || !username.trim()) {
      toast({
        ...
        description: 'Please select a role and enter a username.',
        variant: 'destructive'
      });
      return;
    }
